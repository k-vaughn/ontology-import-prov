...
=== "SVG (interactive)"
    ...
    <text xml:space="preserve" text-anchor="start" x="14.25" y="-29.73" font-family="Arial" font-size="12.00">Role</text>
...
| [definition](https://w3id.org/citydata/imported//definition) | A role is the function of an entity or agent with respect to an activity, in the context of a usage, generation, invalidation, association, start, and end. |
| [dm](https://w3id.org/citydata/imported//dm) | http://www.w3.org/TR/2013/REC-prov-dm-20130430/#term-attribute-role |
